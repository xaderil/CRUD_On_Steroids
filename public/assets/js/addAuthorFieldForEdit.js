...
var template = '<div class="input-group help-blockEdit"><input type="text" name = "authors[]" class="form-control" placeholder="Автор"/></div>';
...
$('.add-fieldEdit').click(function (node, child) {
    ...
    $('.help-blockEdit').last().append(temp);
});
